                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              borderWidth: 1,
                              borderStyle: 'solid',
                              borderColor: isActive ? 'rgba(0, 123, 255, 0.6)' : 'transparent',
                              backgroundColor: isActive ? 'rgba(0, 123, 255, 0.25)' : 'transparent',
                              borderLeftWidth: 3,
                              borderLeftColor: isActive ? 'rgba(0,123,255,1)' : 'transparent',
                            ...
                            return (
                              <div
                                ...
                                style={{
                                  ...
                                  borderWidth: 1,
                                  borderStyle: 'solid',
                                  borderColor: isActive ? 'rgba(40, 167, 69, 0.6)' : 'transparent',
                                  backgroundColor: isActive ? 'rgba(40, 167, 69, 0.25)' : 'transparent',
                                  borderLeftWidth: 3,
                                  borderLeftColor: isActive ? 'rgba(40,167,69,1)' : 'transparent',
                                  paddingLeft: isActive ? '6px' : '8px',
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            borderWidth: 1,
                            borderStyle: 'solid',
                            borderColor: isActive ? 'rgba(40, 167, 69, 0.6)' : (isHovered ? 'rgba(0, 123, 255, 0.3)' : 'transparent'),
                            backgroundColor: isActive ? 'rgba(40, 167, 69, 0.25)' : (isHovered ? 'rgba(0, 123, 255, 0.15)' : 'transparent'),
                            borderLeftWidth: 3,
                            borderLeftColor: isActive ? 'rgba(40,167,69,1)' : (isHovered ? 'rgba(0,123,255,0.5)' : 'transparent'),
                            paddingLeft: isActive ? '6px' : '8px',
