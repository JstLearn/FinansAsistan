...
> = React.forwardRef((props, forwardedRef) => {
  ...
  // PATCH: Wrap password inputs in a form to suppress browser accessibility warning
  // "Password field is not contained in a form"
  if (type === 'password') {
    return createElement('form', { style: { display: 'contents' }, onSubmit: (e) => e.preventDefault() }, element);
  }
